        ...
        <nav className="flex justify-between items-center px-10 py-5 bg-black/80 backdrop-blur-sm border-b border-syncode-gray-700 sticky top-0 z-[100]">
            ...
            <div className="flex gap-8 items-center">
                {isAuthenticated && (
                    <>
                        <a
                            className={`no-underline text-xs font-normal cursor-pointer tracking-widest uppercase font-mono transition-colors duration-200 hover:text-white ${
                                location.pathname === '/dashboard' ? 'text-white' : 'text-syncode-gray-300'
                            }`}
                        ...
                        <a
                            className={`no-underline text-xs font-normal cursor-pointer tracking-widest uppercase font-mono transition-colors duration-200 hover:text-white ${
                                location.pathname === '/search' ? 'text-white' : 'text-syncode-gray-300'
                            }`}
            ...
            <div className="flex items-center gap-4">
                {isAuthenticated ? (
                    ...
                    <button 
                        className="bg-transparent border border-white text-white px-4 py-2 cursor-pointer uppercase font-mono text-[11px] tracking-wide transition-all duration-200 hover:bg-white hover:text-black"
